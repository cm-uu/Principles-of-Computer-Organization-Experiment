set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clkk_IBUF]
...
set_property IOSTANDARD LVCMOS33 [get_ports alustr]
set_property IOSTANDARD LVCMOS33 [get_ports clkk]
set_property IOSTANDARD LVCMOS33 [get_ports input_sel]
set_property IOSTANDARD LVCMOS33 [get_ports reg_from_out]
set_property IOSTANDARD LVCMOS33 [get_ports regwr]
set_property IOSTANDARD LVCMOS33 [get_ports reset_rom_addr]
set_property IOSTANDARD LVCMOS33 [get_ports resetn]
set_property PACKAGE_PIN Y3 [get_ports clkk]
set_property PACKAGE_PIN AC21 [get_ports alustr]
set_property PACKAGE_PIN AD24 [get_ports input_sel]
set_property PACKAGE_PIN AC22 [get_ports reg_from_out]
set_property PACKAGE_PIN AC23 [get_ports regwr]
set_property PACKAGE_PIN AB6 [get_ports reset_rom_addr]
set_property PACKAGE_PIN W6 [get_ports resetn]
